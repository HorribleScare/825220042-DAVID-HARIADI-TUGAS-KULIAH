    ...
    <div class="container-fluid">
        <div class="container-xl mt-5 py-5">
            <div class="row mx-auto">
                ...
                <div class="col-md-8">
                    <?php
                    $queryevent = mysqli_query( $connection, "SELECT * FROM event a JOIN kabupaten k ON (a.kabupatenKODE = k.kabupatenKODE) ORDER BY eventID DESC limit $mulaitampilan, $jumlahtampilan " );
                    ...
                    <div class="media mb-4 list">
                        <div class="row mx-auto">
                            <div class="col-sm-5">
                                <img src="imagesevent/<?php echo $rowevent["eventFoto"]?>" class="align-self-start img-fluid w-100 rounded" alt="Gambar Tidak Ada">
								<p class="mt-1"><?php echo $rowevent["eventFotoKet"]?></p>
                            </div>
                            <div class="col-sm-7 mt-2">
                                <div class="media-body text-justify kolomketeranganevent">
									<strong><a href="WisataSearch.php?kabupaten=<?php echo $rowevent["kabupatenKODE"]?>&value=Destinasi&area=semua">Kabupaten&nbsp;<?php echo $rowevent["kabupatenNAMA"]?></a></strong>
                                    <h5 class="mt-2 mb-1"><strong><a href=""><?php echo $rowevent["eventNama"]?></a></strong></h5>
                                    <p><strong>Event on&nbsp;<?php echo $rowevent["eventTanggalMulai"], " - ", $rowevent["eventTanggalSelesai"]?></strong></p>
                                    <p><?php echo $rowevent["eventKeterangan"]?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    $queryevent = mysqli_query( $connection, "SELECT * FROM event a JOIN kabupaten k ON (a.kabupatenKODE = k.kabupatenKODE) ORDER BY eventID DESC " );
                    $jumlahrecord = mysqli_num_rows( $queryevent );
