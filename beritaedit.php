    ...
    <div class="container-fluid">
        <div class="card shadow mb-4">
            ...
            if (isset($_POST['Simpan'])) {
                ...
                mysqli_query($connection, "UPDATE berita SET beritajudul = '$judulberita', beritainti = '$intiberita', penulis = '$penulisberita', penerbit = '$penerbitberita', tanggalterbit = '$tanggalterbit', destinasiID = '$kodedestinasi' WHERE beritaID = '$idberita'");
                header("location:berita.php");
            }
            ...
            $editdestinasi = mysqli_query($connection, "SELECT * FROM berita b JOIN destinasi d ON (b.destinasiID = d.destinasiID) WHERE beritaID = '$kodeberita'");
                    ...
                    <div class="col-xl">
                        ...
                        <form method="POST">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="idberita" name="inputid" placeholder="ID Berita" value="<?php echo $rowedit["beritaID"] ?>" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="penulisberita" name="inputpenulis" placeholder="Penulis" value="<?php echo $rowedit["penulis"] ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="penerbitberita" class="col-sm-2 col-form-label">Penerbit</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="penerbitberita" name="inputpenerbit" placeholder="Penerbit" value="<?php echo $rowedit["penerbit"] ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="tanggalterbit" class="col-sm-2 col-form-label">Tanggal Terbit</label>
                                <div class="col-sm-10">
                                    <input type="date" class="form-control" id="tanggalterbit" name="inputtanggal" value="<?php echo $rowedit["tanggalterbit"] ?>">
                                </div>
                            </div>
                            <div class="form-group row">
