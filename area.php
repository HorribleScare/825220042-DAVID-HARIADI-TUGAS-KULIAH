		...
		<div class="card shadow mb-4">
			...
			if (isset($_POST['Simpan'])) {
				...
				if (!empty($areaid)) {
					...
					mysqli_query($connection, "insert into area values ('$areaid', '$areanama', '$areawilayah', '$areaketerangan', '$areakabupaten')");
					header("location:area.php");
				} else {
					echo "<script>alert('ANDA HARUS MENGISI DATA'); document.location='area.php'</script>";
				}
			}
					...
					<div class="col-xl">
						...
						<form method="POST" id="form">
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" id="areaid" name="inputid" placeholder="ID Area" maxlength="4">
								</div>
							</div>
							<div class="form-group row">
								<label for="areanama" class="col-sm-2 col-form-label">Nama Area</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" id="areanama" name="inputnama" placeholder="Nama Area">
								</div>
							</div>
							<div class="form-group row">
								<label for="areawilayah" class="col-sm-2 col-form-label">Wilayah Area</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" id="areawilayah" name="inputwilayah" placeholder="Wilayah Area">
								</div>
							</div>
							<div class="form-group row">
								<label for="areaketerangan" class="col-sm-2 col-form-label">Keterangan Area</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" id="areaketerangan" name="inputketerangan" placeholder="Keterangan Area">
								</div>
							</div>
							<div class="form-group row">
								<label for="areaprovinsi" class="col-sm-2 col-form-label">Nama Kabupaten</label>
								<div class="col-sm-10">
						...
						<table class="table table-hover mt-3">
							...
							<tbody>
								...
								if (isset($_POST["kirim"])) {
									$search = $_POST['search'];
									$query = mysqli_query($connection, "SELECT * FROM area a JOIN kabupaten k ON (a.kabupatenKODE = k.kabupatenKODE) WHERE a.areaID like '%" . $search . "%' OR areanama like '$search%'");
								} else {
