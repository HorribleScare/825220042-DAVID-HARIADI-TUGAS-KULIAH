        ...
        <div class="card shadow mb-4">
            ...
            if (isset($_POST['Simpan'])) {
                ...
                if (!empty($idhotel)) {
                    ...
                    mysqli_query($connection, "INSERT INTO hotel VALUES ('$idhotel', '$namahotel', '$alamathotel', '$kethotel', '$nama', '$kodearea' )");
                    header("location:hotel.php");
                } else {
                    echo "<script>alert('ANDA HARUS MENGISI DATA'); document.location='hotel.php'</script>";
                }
            }
                    ...
                    <div class="col-xl">
                        ...
                        <form method="POST" enctype="multipart/form-data">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="idhotel" name="inputid" placeholder="ID hotel" maxlength="4">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="namahotel" name="inputalamat" placeholder="Alamat Hotel">
                                </div>
                            </div>
                            <div class="form-group row">
