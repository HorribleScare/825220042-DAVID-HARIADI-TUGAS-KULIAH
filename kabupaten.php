        ...
        <div class="card shadow mb-4">
            ...
            if (isset($_POST['Simpan'])) {
                ...
                if (!empty($kodekabupaten)) {
                    ...
                    mysqli_query($connection, "INSERT INTO kabupaten VALUES ('$kodekabupaten', '$namakabupaten', '$alamatkabupaten', '$keterangankabupaten', '$ikonkabupaten', '$keteranganikon', '$idprovinsi' )");
                    header("location:kabupaten.php");
                } else {
                    echo "<script>alert('ANDA HARUS MENGISI DATA'); document.location='kabupaten.php'</script>";
                }
            }
                    ...
                    <div class="col-xl">
                        ...
                        <form method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="keterangankabupaten" name="inputketkabupaten" placeholder="Keterangan Kabupaten">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="keteranganikon" name="inputketikon" placeholder="Keterangan Ikon">
                                </div>
                            </div>
                            <div class="form-group row">
