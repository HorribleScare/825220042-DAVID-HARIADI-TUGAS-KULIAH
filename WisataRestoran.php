    ...
    <div class="container-fluid">
        <div class="container-xl mt-5 py-5">
            <div class="row mx-auto">
                ...
                <div class="col-md-8">
                    <?php
                    $queryrestoran = mysqli_query( $connection, "SELECT * FROM restoran h JOIN area a ON (h.areaID = a.areaID) JOIN kabupaten k ON (a.kabupatenKODE = k.kabupatenKODE) ORDER BY h.restoranID DESC limit $mulaitampilan, $jumlahtampilan " );
                    ...
                    $queryrestoran = mysqli_query( $connection, "SELECT * FROM restoran h JOIN area a ON (h.areaID = a.areaID) JOIN kabupaten k ON (a.kabupatenKODE = k.kabupatenKODE) ORDER BY h.restoranID DESC " );
