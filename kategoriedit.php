    ...
    <div class="container-fluid">
        <div class="card shadow mb-4">
            ...
            if (isset($_POST['Simpan'])) {
                ...
                mysqli_query($connection, "UPDATE kategori SET kategorinama = '$kategorinama', kategoriketerangan = '$kategoriket', kategorireferensi = '$kategoriref' WHERE kategoriID = '$kategorikode'");
                header("location:kategori.php");
            }
                    ...
                    <div class="col-xl">
                        ...
                        <form method="POST">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="kodekategori" name="inputkode" placeholder="Kode Kategori" value="<?php echo $rowedit["kategoriID"] ?>" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="namakategori" class="col-sm-2 col-form-label">Nama</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="namakategori" name="inputnama" placeholder="Nama Kategori" value="<?php echo $rowedit["kategorinama"] ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="ketkategori" class="col-sm-2 col-form-label">Keterangan</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="ketkategori" name="inputket" placeholder="Keterangan Kategori" value="<?php echo $rowedit["kategoriketerangan"] ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="refkategori" class="col-sm-2 col-form-label">Referensi</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="refkategori" name="inputref" placeholder="Referensi Kategori" value="<?php echo $rowedit["kategorireferensi"] ?>">
                                </div>
                            </div>
                            <div class="form-group row">
